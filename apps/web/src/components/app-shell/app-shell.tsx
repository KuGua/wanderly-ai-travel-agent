    ...
    <div className="min-h-screen bg-background landscape:grid landscape:grid-cols-[5.5rem_minmax(0,1fr)]">
      <aside className="relative z-50 h-16 bg-sidebar text-sidebar-foreground landscape:sticky landscape:top-0 landscape:h-screen">
        <div className="flex h-full items-center gap-2 px-3 landscape:flex-col landscape:gap-[18px] landscape:px-3 landscape:py-[22px]">
          ...
          <nav className="flex gap-1 landscape:mt-3 landscape:flex-col landscape:gap-[9px]" aria-label="Primary navigation">
          ...
          <button
            ...
            className="ml-auto grid size-11 place-items-center rounded-full border-2 border-[#9ce0d4] bg-[#0b5264] text-sidebar-foreground focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-sidebar-ring/50 landscape:mt-auto landscape:ml-0"
          >
