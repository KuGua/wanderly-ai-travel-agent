...
ALTER TABLE trip_invitations
  ...
  ADD COLUMN IF NOT EXISTS recipient_email_hash varchar(64),
  ADD COLUMN IF NOT EXISTS recipient_email_masked varchar(256);
...
DROP INDEX IF EXISTS trip_invitations_one_pending_recipient_email;
