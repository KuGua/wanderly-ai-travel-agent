...
| `agent_skill_runs_total` | counter | operation, outcome | operation ∈ `["profile","consent","research","readiness","planning","review","confirmation","booking"]`; outcome ∈ `["success","failure","rejected","timeout"]` |
| `agent_task_duration_ms` | histogram | operation, outcome | operation ∈ `["conversation","plan","replan"]`; outcome ∈ `["completed","failed","cancelled"]`; buckets = `[100,250,500,1000,2000,5000,10000,30000,60000,300000]` |
| `agent_task_outcomes_total` | counter | operation, outcome | operation ∈ `["conversation","plan","replan"]`; outcome ∈ `["completed","failed","cancelled","retrying"]` |
