...
export const DEFAULT_REDACT_KEYS = /^(passportNumber|dateOfBirth|nationality|body|message|privateMessage|redactedSummary|valueJson|value|note|reason|rawValue|orchestratorConfidential|projectionManifest)$/i;
