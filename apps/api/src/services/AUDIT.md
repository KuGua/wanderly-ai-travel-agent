...
- Trip and consent: `TRIP_CREATE`, `TRIP_JOIN`, `TRIP_TITLE_UPDATE`, `TRIP_DRAFT_BRIEF_UPDATE`, `CONSENT_GRANT`, `CONSENT_REVOKE`.
- Trip lifecycle: `TRIP_INVITATION_CREATE`, `TRIP_INVITATION_ACCEPT`, `TRIP_INVITATION_REVOKE`, `TRIP_DEFAULT_THREAD_PROVISION`, `EXPLORATION_START`, `TRIP_ACTIVATE`.
...
- `TRIP_CREATE`, `TRIP_JOIN`, `TRIP_TITLE_UPDATE`, `TRIP_DRAFT_BRIEF_UPDATE`
- `TRIP_INVITATION_CREATE`, `TRIP_INVITATION_ACCEPT`, `TRIP_INVITATION_REVOKE`, `TRIP_DEFAULT_THREAD_PROVISION`, `EXPLORATION_START`, `TRIP_ACTIVATE`
